...
var _HSJG2 = _interopRequireDefault(_HSJG);

var _XZBA = require('../json/req/upload/ICP/XZBA/XZBA');

var _XZBA2 = _interopRequireDefault(_XZBA);

var _XZWZ = require('../json/req/upload/ICP/XZWZ/XZWZ');

var _XZWZ2 = _interopRequireDefault(_XZWZ);

var _XZJR = require('../json/req/upload/ICP/XZJR/XZJR');

var _XZJR2 = _interopRequireDefault(_XZJR);

var _XZBA3 = require('../json/req/upload/IP/XZBA/XZBA');

var _XZBA4 = _interopRequireDefault(_XZBA3);

var _SCBA = require('../json/req/upload/IP/SCBA/SCBA');

var _SCBA2 = _interopRequireDefault(_SCBA);
    ...
    _createClass(IspService, [{
      ...
      * */
      ...
      value: function decryptContent(_ref) {
        ...
        var _ref2$ = _ref2[0];
        var filename = _ref2$ === undefined ? '' : _ref2$;
        var _ref2$2 = _ref2[1];
        var beianInfo = _ref2$2 === undefined ? '' : _ref2$2;
        var _ref2$3 = _ref2[2];
        var beianInfoHash = _ref2$3 === undefined ? '' : _ref2$3;
        var compressionFormat = arguments.length <= 1 || arguments[1] === undefined ? COMPRESSIONFORMAT : arguments[1];
        var hashAlgorithm = arguments.length <= 2 || arguments[2] === undefined ? HASHALGORITHM : arguments[2];
        var encryptAlgorithm = arguments.length <= 3 || arguments[3] === undefined ? ENCRYPTALGORITHM : arguments[3];
      ...
      value: function genbeianInfo(json, type) {
        ...
        return regeneratorRuntime.mark(function _callee21() {
          var clip, img, assignedJson, xml2, ret, c;
            ...
            while (1) {
              switch (_context21.prev = _context21.next) {
                ...
                case 29:
                  ...
                  assignedJson = (0, _XZBA2.default)(json);
                ...
                case 70:
                  ...
                  assignedJson = (0, _XZWZ2.default)(json);
                ...
                case 110:
                  ...
                  assignedJson = (0, _XZJR2.default)(json);
                  xml2 = json2xml(assignedJson, { attributes_key: 'attr', header: true });
                  _context21.next = 116;
                  return me.encryptContent(iconv.encode(xml2, 'GBK'));
                ...
                case 120:
                  _context21.prev = 120;
                  _context21.t2 = _context21['catch'](87);
                ...
                case 150:
                  ...
                  assignedJson = (0, _HSJG2.default)(json);
                  xml2 = json2xml(assignedJson, { attributes_key: 'attr', header: true });
                  _context21.next = 156;
                  return me.encryptContent(iconv.encode(xml2, 'GBK'));
                ...
                case 160:
                  _context21.prev = 160;
                  _context21.t3 = _context21['catch'](127);
                ...
                case 166:
                  ...
                  ssignedJson = (0, _XZBA4.default)(json);
                  xml2 = json2xml(assignedJson, { attributes_key: 'attr', header: true });
                ...
                case 176:
                  _context21.prev = 176;
                  _context21.t4 = _context21['catch'](167);
                ...
                case 182:
                  ...
                  assignedJson = (0, _SCBA2.default)(json);
                  xml2 = json2xml(assignedJson, { attributes_key: 'attr', header: true });
                  // fso.writeFileSync('/Users/hujiabao/Downloads/ip_xzba.xml',xml2,'utf8');
                  _context21.next = 188;
                  return me.encryptContent(iconv.encode(xml2, 'GBK'));
                ...
                case 192:
                  _context21.prev = 192;
                  _context21.t5 = _context21['catch'](183);
          ...
          }, _callee21, this, [[6, 40], [47, 80], [87, 120], [127, 160], [167, 176], [183, 192]]);
        });
      }
    }, {
      ...
      value: function gettenantPubips() {
        var tId = arguments.length <= 0 || arguments[0] === undefined ? 0 : arguments[0];
            ...
            while (1) {
              switch (_context24.prev = _context24.next) {
                case 0:
                  ...
                  tenantId = tId > 0 ? tId : this.session.user.tenantid;
