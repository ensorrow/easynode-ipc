...
(function () {
  ...
  var FILTER_CONDITION_PHOTO_PASSED = 6;

  var FILTER_CONDITION_ALL_B = 3;
  var FILTER_CONDITION_CHECKING_B = 1;
  var FILTER_CONDITION_PASSED_B = 2;
      ...
      */
      ...
      value: function getRecords() {
        ...
        return regeneratorRuntime.mark(function _callee7() {
          var conn, tenantid, isadmin, filter, page, rpp, ret, model;
      ...
      value: function getRecordsb() {
        ...
        return regeneratorRuntime.mark(function _callee8() {
          var conn, filter, page, rpp, ret, model;
            ...
            while (1) {
              switch (_context10.prev = _context10.next) {
                ...
                case 9:
                  ...
                  if (!(filter == FILTER_CONDITION_ALL_B)) {
                    _context10.next = 16;
                    break;
                  }
                ...
                case 16:
                  if (!(filter == FILTER_CONDITION_CHECKING_B)) {
                    _context10.next = 22;
                    break;
                  }
                ...
                case 22:
                  if (!(filter == FILTER_CONDITION_PASSED_B)) {
                    _context10.next = 26;
                    break;
                  }

                  _context10.next = 25;
                  return conn.list(model, { applycurtainstatus: { exp: 'in', value: [FILTER_CONDITION_PASSED] } }, { page: page, rpp: rpp }, ['lastlogintime DESC']);
      ...
      value: function getCurtainsb2() {
        ...
        return regeneratorRuntime.mark(function _callee11() {
          var conn, filter, page, rpp, ret, datas, total, offset, limit, sql, sqlCount;
          ...
          return regeneratorRuntime.wrap(function _callee14$(_context14) {
            while (1) {
              switch (_context14.prev = _context14.next) {
                ...
                case 27:
                  r = _context14.sent;
                  ret = r.affectedRows + r.insertId > 0;
          ...
          return regeneratorRuntime.wrap(function _callee19$(_context19) {
            while (1) {
              switch (_context19.prev = _context19.next) {
                ...
                case 18:
                  r = _context19.sent;
                  return _context19.abrupt('return', r.affectedRows + r.insertId > 0);
          ...
          return regeneratorRuntime.wrap(function _callee20$(_context20) {
            while (1) {
              switch (_context20.prev = _context20.next) {
                ...
                case 20:
                  r = _context20.sent;
                  return _context20.abrupt('return', r.affectedRows + r.insertId > 0);
          ...
          return regeneratorRuntime.wrap(function _callee21$(_context21) {
            while (1) {
              switch (_context21.prev = _context21.next) {
                ...
                case 14:
                  r = _context21.sent;
                  return _context21.abrupt('return', r.affectedRows + r.insertId > 0);
          ...
          return regeneratorRuntime.wrap(function _callee22$(_context22) {
            while (1) {
              switch (_context22.prev = _context22.next) {
                ...
                case 14:
                  r = _context22.sent;
                  return _context22.abrupt('return', r.affectedRows + r.insertId > 0);
          ...
          return regeneratorRuntime.wrap(function _callee23$(_context23) {
            while (1) {
              switch (_context23.prev = _context23.next) {
                ...
                case 24:
                  return _context23.abrupt('return', r.affectedRows + r.insertId > 0);
          ...
          return regeneratorRuntime.wrap(function _callee25$(_context25) {
            while (1) {
              switch (_context25.prev = _context25.next) {
                ...
                case 11:
                  r = _context25.sent;
                  return _context25.abrupt('return', r.affectedRows + r.insertId > 0);
          ...
          return regeneratorRuntime.wrap(function _callee26$(_context26) {
            while (1) {
              switch (_context26.prev = _context26.next) {
                ...
                case 11:
                  r = _context26.sent;
                  return _context26.abrupt('return', r.affectedRows + r.insertId > 0);
          ...
          return regeneratorRuntime.wrap(function _callee34$(_context34) {
            while (1) {
              switch (_context34.prev = _context34.next) {
                ...
                case 15:
                  r = _context34.sent;
                  return _context34.abrupt('return', r.affectedRows + r.insertId > 0);
