                        ...
                        while (1) {
                            switch (_context21.prev = _context21.next) {
                                case 0:
                                    ...
                                    _context21.next = 6;
                                    return me.getPhoto(json.record.sitemanagerurl + c, PhotoSizeLimit.WEBSITEOWNERSIZE, me.MIN, me.MAX, (me.MAX - me.MIN) / 2);
                                ...
                                case 165:
                                    ...
                                    _context21.prev = 166;
                                    assignedJson = IP_XZBA_ASSIGN(json);
                                    xml2 = json2xml(assignedJson, { attributes_key: 'attr', header: true });
                                ...
                                case 181:
                                    ...
                                    _context21.prev = 182;
                                    assignedJson = IP_SCBA_ASSIGN(json);
                                    xml2 = json2xml(assignedJson, { attributes_key: 'attr', header: true });
                                    //fso.writeFileSync('/Users/hujiabao/Downloads/ip_xzba.xml',xml2,'utf8');
                            ...
                            switch (_context24.prev = _context24.next) {
                                case 0:
                                    ...
                                    return _context24.abrupt('return', new Promise(function (res, rej) {
                                        ...
                                        console.log(url);
                                        request.post(url).end(function (err, ret) {
                                            if (err) {
                                                rej();
                                            } else {
                                                res(ret.text);
